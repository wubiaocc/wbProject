...
// 	window.location.href="${ctx}/thirdTranLog/import";
	...
	diag.Drag = true;
	diag.Title = "导入";
	diag.URL = '${ctx}/mrtProInfo/batchImport';
	diag.Width = 600;
	diag.Height = 350;
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								<!-- 检索  -->
								<form id="serachFrom" action="${ctx}/mrtProInfo/list" method="get">
								...
								<table class="table table-striped table-bordered table-hover" style="margin-top:5px;">
									<thead>
										<tr>
											<th class="center" style="width: 50%;">商户名称</th>
											<th class="center" style="width: 50%;">商户号</th>
										</tr>
									</thead>
									<tbody>
									<!-- 开始循环 -->	
