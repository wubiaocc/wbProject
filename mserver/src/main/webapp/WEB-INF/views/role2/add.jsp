			...
			<div class="page-content">
				<div class="row">
					<div id="dialog" class="col-xs-12">
						<form action="${ctx}/memberRole/saveRole" name="roleAddForm" id="roleAddForm"  method="post">
							<div id="zhongxin" style="padding-top:13px;">
							<table class="table table-striped table-bordered table-hover">
								<tr>
									<td style="width:100px; text-align:right; padding-top:13px;">角色名称：</td>
									<td class="span10 date-picker">
										<input type="text" id="name" name="name" onBlur="checkName(this)" placeholder="这里输入名称" validates="required,noSpecial" label="角色名称" maxlength="20"
								...
								<tr>
									...
									<td class="span10 date-picker">
										<input type="text" id="memo" name="memo" label="角色备注"
											value="" style="width:95%;" />
									</td>
		  						 </tr>
							</table>
...
function save(){
	if (checkName(document.getElementById("name"))) {
		if(checkFormValidate(document.getElementById("roleAddForm"))){
			$("#roleAddForm").submit();
		}
	}
}
