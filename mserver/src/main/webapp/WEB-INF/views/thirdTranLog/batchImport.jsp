...
// 	        addRemoveLinks : true,//队列文件添加删除按钮
	...
	function batchImportProductResult() {
		$.ajax({
			url : '${ctx}/thirdTranLog/batchImportProductResult',
			type : "post",
	...
	function productMakeSure() {
		$.ajax({
			url : '${ctx}/thirdTranLog/batchImportProduct',
	...
	function goBack() {
			window.location.href = "${ctx}/thirdTranLog/list";
	}
</script>
									...
									<table class="table table-striped table-bordered table-hover">
										<tr>
											...
											<td style="width: 120px; padding-top: 13px;"><a id="add"
												...
												href="${ctx}/thirdTranLog/download">
