				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								...
								<tr height="35">
									<td style="width:69px;"><a href="javascript:toAdd();" class="btn btn-sm btn-success">新增权益</a></td>
								</tr>
							    </table>
								<!-- 检索  -->
								<table class="table table-striped table-bordered table-hover" style="margin-top:5px;">
									<thead>
										<tr>
											<th class="center" style="width: 5%;">权益代码</th>
											<th class="center" style="width: 5%;">会员类型</th>
									...
									<c:choose>
										<c:when test="${not empty page.result}">
											<c:forEach items="${page.result}" var="memberInterests" varStatus="vs">
												<tr>
													<td align="center">${memberInterests.interestsCode}</td>
													<td align="center">${memberInterests.memberType}</td>
													<%-- <td align="center">${tranLog.tranLogProvider}</td> --%>
													<td align="center">${memberInterests.interestsContent}</td>
													<td align="center"><fmt:formatDate value="${memberInterests.createTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss" /></td>
													<td class="center">
